...
class Practice_2   
{
	...
	public static void main(String[] args) {
        ...
        int target = 7;
        System.out.println("Length of the smallest subarray whose sum is at least " + target + ": " + lengthOfSmallestSubarray(nums, target));
        System.out.println("Length of the smallest subarray whose sum is at least " + target + ": " + lengthOfSmallestSubarrayOptimized(nums, target));
